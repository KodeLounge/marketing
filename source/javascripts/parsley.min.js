...
!(function(e, t) {
  ...
  l.prototype = {
    ...
    asyncIsValid: function() {
      return (
        ...
        this.whenValid.apply(this, arguments)
      );
    },
  ...
  f.prototype = {
    ...
    parseRequirements: function(t, i) {
      ...
      if (e.isArray(n)) {
        for (var r = d(t, n.length), s = 0; s < r.length; s++)
          r[s] = h(n[s], r[s]);
        return r;
      }
    ...
    (c.prototype = {
      ...
      updateValidator: function(e, t, i) {
        return this.validators[e]
          ? this._setValidator(this, arguments)
  ...
  y.prototype = {
    ...
    getErrorsMessages: function(e) {
      ...
      for (var t = [], i = 0; i < e.validationResult.length; i++)
        t.push(
          e.validationResult[i].errorMessage ||
            this._getErrorMessage(e, e.validationResult[i].assert)
        );
      return t;
    },
      ...
      this._insertErrorWrapper(t),
        t._ui.$errorsWrapper.addClass("filled").append(
          e(t.options.errorTemplate)
            .addClass("parsley-" + i)
            .html(n || this._getErrorMessage(t, r))
        ),
    ...
    updateError: function(e, t, i, n, r) {
      e._ui.$errorsWrapper
        .addClass("filled")
        .find(".parsley-" + t)
        .html(i || this._getErrorMessage(e, n)),
    ...
    focus: function(e) {
      if (
        ...
        !0 === e.validationResult || "none" === e.options.focus)
      )
        return null;
      for (var t = 0; t < e.fields.length; t++) {
        var i = e.fields[t];
        if (
          !0 !== i.validationResult &&
          i.validationResult.length > 0 &&
          "undefined" == typeof i.options.noFocus &&
          ((e._focusedField = i.$element), "first" === e.options.focus)
        )
          break;
      }
    ...
    _getErrorMessage: function(e, t) {
      ...
      return "undefined" != typeof e.options[i]
        ? window.Parsley.formatMessage(e.options[i], t.requirements)
    ...
    _manageClassHandler: function(t) {
      ...
      return "undefined" != typeof i && i.length
        ? i
    ...
    _insertErrorWrapper: function(t) {
      ...
      if ("undefined" != typeof i && i.length)
        return i.append(t._ui.$errorsWrapper);
      var n = t.$element;
      return (
        t.options.multiple && (n = n.parent()), n.after(t._ui.$errorsWrapper)
      );
    },
    actualizeTriggers: function(t) {
      ...
      if (
        (t.options.multiple &&
          (i = e(
            "[" + t.options.namespace + 'multiple="' + t.options.multiple + '"]'
          )),
        i.off(".Parsley"),
        !1 !== t.options.trigger)
      ) {
    ...
    manageFailingFieldTrigger: function(t) {
      return (
        ...
        !new RegExp("change", "i").test(t.options.trigger || "")
          ...
          ? void 0
          : t.$element.on("keyup.ParsleyFailedOnce", !1, e.proxy(t.validate, t))
      );
    },
    reset: function(e) {
      this.actualizeTriggers(e),
  ...
  g.prototype = {
        ...
        return (
          (this._$submitSource =
            ...
            this.$element
              ...
              .first()),
          this._$submitSource.is("[formnovalidate]")
            ? void (this._$submitSource = null)
            : (e.stopImmediatePropagation(),
              e.preventDefault(),
              this.whenValidate(void 0, void 0, e)
                .done(function() {
                  t._submit();
                })
                .always(function() {
    ...
    _submit: function() {
      !1 !== this._trigger("submit") &&
        ...
        this._$submitSource &&
          e('<input class="parsley_synthetic_submit_button" type="hidden">')
    ...
    whenValid: function(t, i) {
      ...
      if (
        ("boolean" != typeof t &&
          "undefined" == typeof i &&
          ((i = t), (t = !1)),
        ("undefined" == typeof i || null === i) && (i = this.getValue()),
        !this.needsValidation(i) && !0 !== t)
      )
        return e.when();
      ...
      return (
        e.each(n, function(t, n) {
          var a = e.when.apply(
            e,
            e.map(n, e.proxy(s, "_validateConstraint", i))
          );
    ...
    _validateConstraint: function(t, i) {
      ...
      return (
        ...
        e.when(r).fail(function(e) {
          !0 === n.validationResult && (n.validationResult = []),
    ...
    bind: function(t, i) {
      ...
      return (
        ...
        "undefined" != typeof i
          ...
          : (this.$element.data("Parsley", n), n._trigger("init"), n)
      );
    }
  };
  var P = e.fn.jquery.split(".");
  if (parseInt(P[0]) <= 1 && parseInt(P[1]) < 8)
  ...
  e.extend($.prototype, l.prototype),
    e.extend(g.prototype, l.prototype),
    e.extend(x.prototype, l.prototype),
    ...
    (V.options = e.extend(a.objectCreate(o), window.ParsleyConfig)),
    (window.ParsleyConfig = V.options),
    (window.Parsley = window.psly = V),
    (window.ParsleyUtils = a);
  var E = (window.Parsley._validatorRegistry = new c(
        ...
        (window.Parsley[i] = e.proxy(E, i)),
          (window.ParsleyValidator[i] = function() {
            return (
              ...
              window.Parsley[i].apply(window.Parsley, arguments)
            );
          });
      }
    ),
  ...
  (e.listen = function(e, n) {
    ...
    (e.listenTo = function(e, n, r) {
      if ((R(), !(e instanceof $ || e instanceof g)))
  ...
  e.extend(!0, V, {
    ...
    addAsyncValidator: function(e, t, i, n) {
      return (
        (V.asyncValidators[e] = { fn: t, url: i || !1, options: n || {} }), this
      );
    },
    eventValidate: function(e) {
      (new RegExp("key").test(e.type) &&
        !this._ui.validationInformationVisible &&
        this.getValue().length <= this.options.validationThreshold) ||
        ((this._ui.validatedOnce = !0), this.whenValidate());
    }
  }),
    V.addValidator("remote", {
      ...
      validateString: function(t, i, n, r) {
        ...
        if ("undefined" == typeof V.asyncValidators[l])
          throw new Error("Calling an undefined async validator: `" + l + "`");
        (i = V.asyncValidators[l].url || i),
          i.indexOf("{value}") > -1
        ...
        (s = e.extend(!0, {}, { url: i, data: o, type: "GET" }, u)),
          ...
          (a = e.param(s)),
          "undefined" == typeof V._remoteCache && (V._remoteCache = {});
    ...
    (window.ParsleyExtend.addAsyncValidator = function() {
      return (
        ...
        V.apply(V.addAsyncValidator, arguments)
      );
    }),
    V.addMessages("en", {
